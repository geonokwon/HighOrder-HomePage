...
export function ExpertCareSection() {
  ...
  return (
    <AnimatedSection className="py-10 md:py-20 bg-transparent px-4">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        {/* 새로운 제목 섹션 */}
        <AnimatedItem direction="up" delay={0.1} className="mb-8 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-6xl font-black mb-8 md:mb-16 leading-tight">
        ...
        <AnimatedItem>
          <span className="text-[#FF9000] font-bold text-2xl md:text-3xl mb-4 md:mb-6 inline-block">
            25년 판매 대수{' '}
            <AnimatedCounter 
              target={1532} 
              suffix="대" 
        ...
        <AnimatedItem delay={0.7}>
          <div className="flex items-center justify-center gap-2 md:gap-4">
            <img src="/ExpertCare/Wing_Left.png" alt="left wing" className="w-10 md:w-24 shrink-0" />
            <p className="text-2xl md:text-5xl font-extrabold text-gray-700 leading-snug">
              지니원은{' '}
              <span className="text-[#FF9000] font-extrabold inline-block text-2xl md:text-5xl">
                <AnimatedCounter 
                  target={16} 
                  suffix="년" 
            ...
            <img src="/ExpertCare/Wing_Right.png" alt="right wing" className="w-10 md:w-24 shrink-0" />
          </div>
        </AnimatedItem>
      </div>
    </AnimatedSection>
