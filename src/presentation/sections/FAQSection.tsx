...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    "4. 엔지니어 방문 시 즉시 수리 가능한 것은 수리하며, 전문 수리가 필요하여 입고 해야 하는 경우 대체 기기로 운영할 수 있도록 도와드립니다.(추후 본품으로 교체)\n" +
    "5. A/S 출동 비용없음"
  },
  {
  ...
  },
  {
    ...
    answer: "1. 신청 시 약정 기간(일시불, 3년)에 따라 다르며, 해지 신청으로 부터 계약 된 약정 기간까지의 서비스 이용료 50%를 부담하게 됩니다."
  }
];
