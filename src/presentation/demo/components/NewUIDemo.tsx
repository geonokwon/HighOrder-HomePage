                    ...
                    {count > 0 && (
                        <div id="cart-container" className={`${isMobile ? 'absolute top-0 right-0 bottom-0 left-8 z-50 bg-white' : 'w-[220px]'} bg-gray-100 flex flex-col`} data-cart-container>
                            ...
                            <div className="h-[60px] flex items-center justify-between px-4" data-cart>
                                <h3 className="text-[20px] font-normal text-[#2e2e2e]" style={{fontFamily: 'BM Jua'}}>
                                    장바구니 <span className="text-red-500">{items.length}</span>
                                </h3>
                                <div className="flex items-center gap-2">
                                    <button 
                                        onClick={clear}
                                        className="w-[70px] h-[24px] border border-[#bebebe] rounded-[20px] bg-transparent text-[#b3b3b3] text-[14px] font-normal hover:bg-gray-50 transition-colors"
                                ...
                                <div className="space-y-3">
                                        ...
                                        {items.map((item, index) => (
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="flex justify-between items-center">
                                                    <h4 className="text-[16px] font-normal text-[#2e2e2e] underline decoration-blue-500" style={{fontFamily: 'BM Jua'}}>
                                                        {item.item.name}
                                                    </h4>
                                                    <button 
                                                        onClick={() => remove(item.item.id)}
                                                        className="w-[50px] h-[20px] border border-[#bebebe] rounded-[10px] bg-transparent text-[#b3b3b3] text-[12px] font-normal hover:bg-gray-50 transition-colors"
                                                        style={{fontFamily: 'BM Jua'}}
                                                    >
                                                        삭제
                                                    </button>
                                                ...
                                                {/* 2열: 가격 + 수량 조절 버튼 */}
                                                <div className="flex justify-between items-center">
                                                    <div className="text-[14px] font-normal text-[#4f4f4f]" style={{fontFamily: 'BM Jua'}}>
                                                    ...
                                                    <div className="w-[80px] h-[24px] bg-[#DADADA] rounded-[6px] flex items-center justify-between px-1">
                                                        <button 
                                                            ...
                                                            className="w-[18px] h-[18px] bg-[#C0C0C0] rounded-[4px] flex items-center justify-center text-[#717070] text-[14px] font-normal hover:bg-[#c7c7c7] transition-colors"
                                                            style={{fontFamily: 'BM Jua'}}
                                                            disabled={item.qty === 1}
                                                        >
                                                            -
                                                        </button>
                                                        <span className="text-[12px] font-normal text-black" style={{fontFamily: 'BM Jua'}}>
                                                            {item.qty}
                                                        </span>
                                                        <button 
                                                            onClick={() => add(item.item)}
                                                            className="w-[18px] h-[18px] bg-white rounded-[4px] flex items-center justify-center text-black text-[14px] font-normal hover:bg-gray-100 transition-colors"
                                                            style={{fontFamily: 'BM Jua'}}
                                                        >
                                                            +
                                                        </button>
                                    ...
                                    {items.length === 0 && (
                                        <div className="text-center py-8">
                                            <p className="text-[14px] text-[#b3b3b3]" style={{fontFamily: 'BM Jua'}}>
                                                장바구니가 비어있습니다
                                            </p>
                                        </div>
                                    )}
                            ...
                            <div className="h-[90px] p-4 flex flex-col justify-between">
                                <div className="flex justify-between items-center">
                                    <span className="text-[14px] font-normal text-[#808080]" style={{fontFamily: 'BM Jua'}}>
                                        총 금액
                                    </span>
                                    <span className="text-[18px] font-normal text-[#1b1b1b]" style={{fontFamily: 'BM Jua'}}>
                                ...
                                <button 
                                    ...
                                    className="w-full h-[44px] bg-red-500 text-white rounded-[8px] text-[16px] font-normal hover:bg-red-600 transition-colors"
                                    style={{fontFamily: 'BM Jua'}}
                                    data-order-submit
                                >
                                    주문하기
                        ...
                        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75">
                            ...
                            <div className={`relative bg-white rounded-[20px] w-[480px] flex flex-col ${
                                ...
                                <div className="p-6 pb-4">
                                    <h2 className="text-[20px] font-normal text-black text-center" style={{fontFamily: 'BM Jua'}}>
                                        ...
                                        <div className="space-y-2">
                                            {items.map((item) => (
                                                <div key={item.item.id} className="flex justify-between items-center">
                                                    <span className="text-[18px] font-medium text-black" style={{fontFamily: 'BM Jua'}}>
                                                        {item.item.name} x {item.qty}
                                                    </span>
                                                    <span className="text-[16px] font-medium text-[#4d4d4d]" style={{fontFamily: 'BM Jua'}}>
                                ...
                                <div className="p-6 pt-4">
                                    ...
                                    <div className="flex justify-between items-center mb-4">
                                        <span className="text-[16px] font-normal text-[#4d4d4d]" style={{fontFamily: 'BM Jua'}}>
                                            총 주문 금액
                                        </span>
                                        <span className="text-[20px] font-normal text-[#020202]" style={{fontFamily: 'BM Jua'}}>
                                            {total.toLocaleString()}원
                                        </span>
                                    </div>
                                    ...
                                    <div className="flex gap-3">
                                        <button
                                            ...
                                            className="flex-1 h-[50px] bg-[#929292] text-white rounded-[8px] text-[18px] font-normal hover:bg-[#7a7a7a] transition-colors"
                                            style={{fontFamily: 'BM Jua'}}
                                        >
                                            취소
                                        </button>
                                        <button
                                            ...
                                            className="flex-[1.5] h-[50px] bg-[#df0000] text-white rounded-[8px] text-[18px] font-normal hover:bg-[#c00000] transition-colors"
                                            style={{fontFamily: 'BM Jua'}}
                        ...
                        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75">
                            ...
                            <div className={`relative bg-white flex flex-col ${isMobile ? 'w-[400px] h-[450px]' : 'w-[600px] h-[400px]'}`} style={{borderRadius: '15px'}}>
                                ...
                                <div className={`flex items-center justify-between px-6 border-b border-[#b0b0b0] ${isMobile ? 'h-[50px]' : 'h-[60px]'}`}>
                                    <h2 className="text-[20px] font-normal text-black" style={{fontFamily: 'BM Jua'}}>
                                        직원호출
                                    </h2>
                                    <button 
                                        onClick={() => {
                                    ...
                                    <div className={`flex-1 p-4 ${isMobile ? 'overflow-y-auto scrollbar-hide' : ''}`}>
                                        <div className={`grid gap-3 ${isMobile ? 'grid-cols-1' : 'grid-cols-3'}`}>
                                            ...
                                            {staffRequests.map((request) => (
                                                ...
                                                >
                                                    <span className={`font-normal text-black ${isMobile ? 'text-[12px]' : 'text-[14px]'}`} style={{fontFamily: 'BM Jua'}}>
                                                        {request}
                                                    </span>
                                                </button>
                                            ))}
                                    ...
                                    <div className={`bg-[#dedede] flex flex-col ${isMobile ? 'w-[150px]' : 'w-[200px]'}`} style={{borderBottomRightRadius: '15px'}}>
                                        ...
                                        <div className="flex-1 p-4">
                                            <div className="h-[50px] flex items-center justify-between">
                                                <span className="text-[16px] font-normal text-[#2e2e2e]" style={{fontFamily: 'BM Jua'}}>
                                                    호출내용
                                                </span>
                                                <button 
                                                    onClick={clearAllRequests}
                                                    className="w-[60px] h-[24px] border border-[#bebebe] rounded-[12px] bg-transparent text-[#b3b3b3] text-[12px] font-normal hover:bg-gray-50 transition-colors" 
                                                    style={{fontFamily: 'BM Jua'}}
                                                >
                                                    삭제
                                                </button>
                                            ...
                                            <div className="space-y-2">
                                                {Object.keys(selectedRequests).length === 0 && (
                                                    <p className="text-[12px] text-[#666] text-center" style={{fontFamily: 'BM Jua'}}>
                                                ...
                                                {Object.entries(selectedRequests).map(([name, qty]) => (
                                                    <div key={name} className="flex items-center justify-between text-[12px]">
                                                        <span className="flex-1" style={{fontFamily: 'BM Jua'}}>{name}</span>
                                                        <div className="flex items-center gap-1">
                                                            <button
                                                                onClick={() => minusRequestItem(name)}
                                                                className="w-[20px] h-[20px] border border-[#bebebe] rounded-[4px] flex items-center justify-center text-[10px] hover:bg-gray-200"
                                                                style={{fontFamily: 'BM Jua'}}
                                                            >
                                                                -
                                                            </button>
                                                            <span className="w-[20px] text-center" style={{fontFamily: 'BM Jua'}}>{qty}</span>
                                                            <button
                                        ...
                                        <div className={`bg-[#eeeeee] flex items-center justify-center p-4 ${isMobile ? 'h-[70px]' : 'h-[80px]'}`} style={{borderBottomRightRadius: '15px'}}>
                                            <button 
                                                ...
                                                className="w-full h-[44px] bg-[#ff0000] text-white rounded-[6px] text-[16px] font-normal hover:bg-[#e00000] transition-colors disabled:opacity-40"
                                                style={{fontFamily: 'BM Jua'}}
