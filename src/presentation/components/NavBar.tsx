...
export function NavBar() {
  ...
  // 초기 렌더링 시 즉시 padding 설정 (스크롤 깜빡임 방지)
  useEffect(() => {
    if (typeof document === 'undefined') return;
    
    // admin 페이지나 메인 페이지가 아닌 경우 padding 제거
