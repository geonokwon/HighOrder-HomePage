...
export function CommentSection({ reviewId, isAdmin = false }: CommentSectionProps) {
  const { comments, total, loading, error, createComment, updateComment, deleteComment } = useComments(reviewId);
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {isAdmin && new Date(comment.updatedAt).getTime() !== new Date(comment.createdAt).getTime() && (
