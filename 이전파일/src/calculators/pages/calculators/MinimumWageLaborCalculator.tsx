...
import { calculateMinimumWageLabor } from '../../utils/calculations';
...
export const MinimumWageLaborCalculator: React.FC = () => {
  ...
  useEffect(() => {
    const calculation = calculateMinimumWageLabor({
    ...
    setResults([
      ...
      {
        label: '주 총 지급액',
        value: calculation.weeklyTotalPay,
        format: 'currency'
      },
      {
        label: '월 총 인건비',
        value: calculation.monthlyTotalPay,
        format: 'currency'
      }
    ]);
  }, [values]);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8 pb-36">
      <div className="text-center">
        ...
        <p className="text-gray-600">
          (월별 일수 차이가 있기 때문에 일수 기준 계산은 정확하지 않을 수 있습니다!)
        </p>
        <BannerRow />
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-6">
        ...
        <div className="mb-4">
          ...
          <ul className="space-y-1 text-sm text-gray-600 mb-4">
            <li>• <strong>모든 근로자</strong>: 최저임금법이 적용되는 모든 근로자</li>
            <li>• <strong>정규직/비정규직</strong>: 고용형태와 관계없이 적용</li>
            <li>• <strong>연령 제한</strong>: 만 18세 이상 근로자 (미성년자도 최저임금 적용)</li>
            <li>• <strong>업종 제한</strong>: 모든 사업 또는 사업장에 적용</li>
          </ul>
        </div>
        ...
        <div className="mb-4">
          ...
          <ul className="space-y-1 text-sm text-gray-600 mb-4">
            <li>• <strong>최저임금</strong>: 시급은 최저임금 이상이어야 합니다 (2025년 기준 9,860원)</li>
            <li>• <strong>주휴수당</strong>: 주 15시간 이상 근무 시 지급됩니다</li>
            <li>• <strong>주휴수당 계산</strong>: 시급 × 1일 소정근로시간으로 계산됩니다</li>
            <li>• <strong>월 인건비</strong>: (주 기본급 + 주휴수당) × 4.345주로 계산됩니다</li>
            <li>• <strong>4.345주</strong>: 연간 52주를 12개월로 나눈 평균값입니다</li>
          </ul>
        </div>

        <div className="mb-4">
          <h4 className="font-medium text-gray-800 mb-2">📅 주휴수당 지급 조건</h4>
          <ul className="space-y-1 text-sm text-gray-600 mb-4">
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm text-gray-600">
            <li>• 실제 지급액은 근로계약서, 회사 규정, 세금, 보험료 등에 따라 다를 수 있습니다</li>
            <li>• 소정 근로일에 개근하지 않은 주에는 주휴수당이 지급되지 않습니다</li>
            <li>• 이 계산기는 기본적인 인건비 산정을 위한 참고용입니다</li>
